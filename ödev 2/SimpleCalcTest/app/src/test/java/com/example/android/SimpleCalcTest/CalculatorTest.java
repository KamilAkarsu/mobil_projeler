...
public class CalculatorTest {
    ...
    //TEST for POW HOMEWORK

    //positive integer operands.
    @Test
    public void testPositiveNumbersPow() {
        double resultPow = mCalculator.pow(2d, 2d);
        assertThat(resultPow, is(equalTo(4d)));
    }

    //negative integer as the first operand.
    @Test
    public void testNegativeNumberPow() {
        double resultPow = mCalculator.pow(-2d, 2d);
        assertThat(resultPow, is(equalTo(4d)));
    }

    //negative integer as the second operand.
    @Test
    public void testNegativeNumberPowReverse() {
        double resultPow = mCalculator.pow(2d, -2d);
        assertThat(resultPow, is(equalTo(0.25d)));
    }

    //0 as the first operand and a positive integer as the second operand.
    @Test
    public void testZeroAndPositiveNumberPow() {
    ...
    @Test
    public void testZeroAndPositiveNumberPowReverse() {
        double resultPow = mCalculator.pow(4d, 0d);
        assertThat(resultPow, is(equalTo(1d)));
    }

    //0 as the first operand and -1 as the second operand
    @Test
    public void testZeroNegativeOneNumberPow() {
        double resultPow = mCalculator.pow(0d, -1d);
        assertThat(resultPow, is(equalTo(Double.POSITIVE_INFINITY)));
    }

    //-0 as the first operand and any negative number as the second operand.
    @Test
